...
public class RentACatUnitTest {
	...
	public void setUp() throws Exception {
		...
		//  Refer to the textbook chapter 14.6 on Testing System Output.
	...
	public void testGetCatNumCats3() {
		// preconditions
		// making sure the mock cats return their IDs
		Mockito.when(c1.getId()).thenReturn(1);
		Mockito.when(c2.getId()).thenReturn(2);
		Mockito.when(c3.getId()).thenReturn(3);

		//adding all of the cats
		r.addCat(c1);
		r.addCat(c2);
		r.addCat(c3);
	...
	public void testListCatsNumCats3() {
		...
		// execution steps
		String output = r.listCats().replaceAll("\\r\\n", "\n");
	...
	public void testReturnCatNumCats3() {
		...
		assertTrue(out.toString().replaceAll("\\r\\n", "\n").contains("Welcome back, Old Deuteronomy!\n"));
	}
